            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    @switch(Session::get('lang'))
                        ...
                        @case('pt')
                            <img src="{{ URL::asset('build/images/flags/portugal.jpg') }}" alt="Header Language" height="16">
                        @break
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="{{ url('index/pt') }}" class="dropdown-item notify-item language" data-lang="pt">
                        <img src="{{ URL::asset('build/images/flags/portugal.jpg') }}" alt="user-image" class="me-1"
