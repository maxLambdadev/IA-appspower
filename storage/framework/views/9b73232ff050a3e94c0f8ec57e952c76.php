        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box d-flex flex-column justify-content-center">
                <a href="/" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo-dark.png')); ?>" alt="" width="90">
                    </span>
                </a>
                ...
                <a href="/" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo-light.png')); ?>" alt="" width="90">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    <?php switch(Session::get('lang')):
                        ...
                        <?php case ('pt'): ?>
                            <img src="<?php echo e(URL::asset('build/images/flags/portugal.jpg')); ?>" alt="Header Language" height="16">
                        <?php break; ?>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <!-- item-->
                    <a href="<?php echo e(url('index/pt')); ?>" class="dropdown-item notify-item language" data-lang="pt">
                        <img src="<?php echo e(URL::asset('build/images/flags/portugal.jpg')); ?>" alt="user-image" class="me-1"
                            height="12"> <span class="align-middle">Português</span>
                    </a>
...
<?php /**PATH G:\bs\Luisory\Oscar\AI\IA-appspower\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>